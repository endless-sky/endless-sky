...
public:
	...
	void AddGunPort(const Point &point, const Hardpoint::AnglesParameter &angles, const Outfit *outfit = nullptr);
	void AddTurret(const Point &point, const Hardpoint::AnglesParameter &angles, const Outfit *outfit = nullptr);
