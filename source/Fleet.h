...
public:
	...
	void Enter(const System &system, std::list<std::shared_ptr<Ship>> &ships, const Planet *planet = nullptr,
		std::shared_ptr<std::string> limitedFleetId = nullptr) const;
	...
	static const System *Enter(const System &system, Ship &ship, const System *source = nullptr,
		std::shared_ptr<std::string> limitedFleetId = nullptr);
