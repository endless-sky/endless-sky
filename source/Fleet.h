...
public:
	...
	void Enter(const System &system, std::vector<std::shared_ptr<Ship>> &ships, const Planet *planet = nullptr) const;
	...
	void Place(const System &system, std::vector<std::shared_ptr<Ship>> &ships,
