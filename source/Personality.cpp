...
namespace {
	enum PersonalityTrait {
		PACIFIST, FORBEARING, TIMID, DISABLES, PLUNDERS, HUNTING, STAYING, ENTERING, NEMESIS,
		SURVEILLANCE, UNINTERESTED, WAITING, DERELICT, FLEEING, ESCORT, FRUGAL, COWARD, VINDICTIVE,
		SWARMING, UNCONSTRAINED, MINING, HARVESTS, APPEASING, MUTE, OPPORTUNISTIC, MERCIFUL,
		TARGET, MARKED, LAUNCHING, DARING, SECRETIVE, RAMMING
	};
