...
public:
	...
	bool Do(Trigger trigger, PlayerInfo &player, UI *ui = nullptr, const std::shared_ptr<Ship> &boardingShip = nullptr, int resumeIndex = -1);
	static const std::string &NameForTrigger(Trigger trigger);
