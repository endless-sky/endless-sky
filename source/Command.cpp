...
const Command Command::STRAFERIGHT(1uL << 29, "Strafe right");
const Command Command::STRAFELEFT(1uL << 30, "Strafe left");
const Command Command::MINING(1uL << 31, "Fleet: Mine resources");
// warning nearing the limit of 1uL which is 32-bits
