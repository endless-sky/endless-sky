...
const Command Command::HOLD_POSITION(ONE << 25, "Fleet: Hold position");
const Command Command::HOLD_FIRE(ONE << 26, "Fleet: Hold fire");
const Command Command::AMMO(ONE << 27, "Fleet: Toggle ammo usage");
const Command Command::WAIT(ONE << 28, "");
const Command Command::STOP(ONE << 29, "");
const Command Command::SHIFT(ONE << 30, "");
const Command Command::MOUSE_TURNING_HOLD(ONE << 31, "Mouse turning (hold)");
const Command Command::MOUSE_TURNING_TOGGLE(ONE << 32, "Mouse turning (toggle)");
