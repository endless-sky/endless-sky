...
public:
	...
	double FiringEngineScramble() const;
	...
	double EngineScramblingDamage() const;
...
private:
	...
	static const int ENGINE_SCRAMBLING_DAMAGE = 9;
...
inline double Weapon::FiringEngineScramble() const { return firingEngineScramble; }
...
inline double Weapon::EngineScramblingDamage() const { return TotalDamage(ENGINE_SCRAMBLING_DAMAGE); }
