...
void MainPanel::Step()
{
	...
	if((isActive || player.TeleportationStatus() == PlayerInfo::TELEPORTED) && player.GetPlanet() && !player.GetPlanet()->IsWormhole())
	{
...
{
	if(player.TeleportationStatus() != PlayerInfo::TELEPORTED)
		engine.Place();
