...
namespace {
	...
	const map<string, int> SCALE = {
		...
		{"energy generation", 0},
		{"docked energy generation", 0},
		{"fuel consumption", 0},
		{"fuel energy", 0},
		{"fuel generation", 0},
		{"docked fuel generation", 0},
		{"fuel heat", 0},
		{"heat generation", 0},
		{"docked heat generation", 0},
		{"heat dissipation", 0},
		{"hull repair rate", 0},
		{"hull energy", 0},
		{"hull fuel", 0},
		...
		{"delayed hull fuel", 0},
		{"delayed hull heat", 0},
		{"docked hull repair rate", 0},
		{"docked hull energy", 0},
		{"docked hull fuel", 0},
		{"docked hull heat", 0},
		...
		{"docked shield generation", 0},
		{"docked shield energy", 0},
		{"docked shield fuel", 0},
		{"docked shield heat", 0},
