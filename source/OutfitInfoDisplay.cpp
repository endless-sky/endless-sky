...
namespace {
	...
	const map<string, int> SCALE = {
		...
		{"weapon jamming resistance energy", 0},
		{"weapon jamming resistance fuel", 0},
		{"weapon jamming resistance heat", 0},
		{"jump speed", 0},
