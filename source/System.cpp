...
// Return how much ramscoop is generated by this system, depending on the given ramscoop value and velocity.
double System::RamscoopFuel(double shipRamscoop, double velocity, double scale) const
{
	...
	return max(0., SolarWind() * .03 * scale * ramscoopMultiplier * (sqrt(shipRamscoop * velocity) + universal)
		+ ramscoopAddend);
}
