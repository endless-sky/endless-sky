...
double System::RamscoopFuel(double shipRamscoop, double speed, double scale) const
{
	...
	return max(0., SolarWind() * .03 * scale * ramscoopMultiplier * (sqrt(shipRamscoop * speed) + universal)
		+ ramscoopAddend);
}
