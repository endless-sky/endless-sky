...
public:
	...
	double EngineScrambling() const noexcept;
...
private:
	...
	double ionDamage = 0.;
	double engineScramblingDamage = 0.;
...
inline double DamageDealt::EngineScrambling() const noexcept { return engineScramblingDamage; }
