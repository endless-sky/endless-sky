...
#ifndef BLUEPRINTS_PANEL_H_
#define BLUEPRINTS_PANEL_H_
...
// This panel displays detailed information about the design player and their fleet.
class BlueprintsPanel : public Panel {
public:
	explicit BlueprintsPanel(PlayerInfo &player);
	explicit BlueprintsPanel(PlayerInfo &player, InfoPanelState panelState);

	virtual void Draw() override;

	// The blueprints panel allow fast-forward to stay active.
...
private:
	// Draw the main section of this panel.
