...
EscortDisplay::Icon::Icon(const Ship &ship, bool isHere, bool fleetIsJumping, bool isSelected)
	...
	notReadyToJump(fleetIsJumping && !ship.GetHyperpacePercentage() && !ship.IsReadyToJump(true)),
	cannotJump(fleetIsJumping && !ship.GetHyperpacePercentage() && !ship.JumpsRemaining()),
