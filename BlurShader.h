...
#ifndef BLUR_SHADER_H_
#define BLUR_SHADER_H_
...
// This shader has additional complexity that allows it to render motion blur,
// which makes fast-moving objects draw more smoothly, but takes more GPU power.
class BlurShader {
public:
