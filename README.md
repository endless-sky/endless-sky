...
# Archival
Endless Sky's main discussion and development area used to be [here on google groups](https://groups.google.com/g/endless-sky) (and an [alternative link](http://groups.google.com/group/endless-sky)), but it is no longer used regularly and is included here solely for historical purposes. Note that due to factors outside our control, the google groups has become difficult to access for most people, and is almost impossible to access for any google account that has not already visited it.
